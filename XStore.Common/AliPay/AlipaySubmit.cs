   ...
   /// <summary>
    ...
    public class Submit
    {
        ...
        public static string BuildRequest(SortedDictionary<string, string> sParaTemp, string strMethod, string strButtonValue)
        {
            ...
            sbHtml.Append(" <div id='body' style='clear:left'>");
            sbHtml.Append("<dl class='content'>");
        ...
        public static XmlDocument SendPostInfo(SortedDictionary<string, string> sParaTemp)
        {
            //待请求参数数组字符串
        ...
        /// <param name="gateway">网关地址</param>
        /// <returns>支付宝返回XML处理结果</returns>
        public static XmlDocument SendGetInfo(SortedDictionary<string, string> sParaTemp)
        {
            //待请求参数数组字符串
            Encoding code = Encoding.GetEncoding(_input_charset);
            string strRequestData = BuildRequestParaToString(sParaTemp, code);
            ...
            //构造请求地址
            string strUrl = GATEWAY_NEW + strRequestData;
